...
def handle_websocket_message(_) -> None:
    """
    This function handles websocket message.

    Args:
        _: Description of param1.
    ...
    if close_time_utc != handle_websocket_message.LAST_CLOSE:
        candle_data = {
            ...
            "close_time_utc": handle_websocket_message.LAST_CLOSE,
        }
