...
class TestFetchCandles(unittest.TestCase):
    ...
    def test_fetch_candles_success(self, mock_get_klines):
        # Mock data
        mock_get_klines.return_value = [
            [1609459200000, "29000.0", "29500.0", "28500.0", "29000.0", "1000", 1609462800000, "29000000", 100, "500", "14500000", "0"]
        ]
    ...
    @patch('helpers.fetch_candles.client.get_klines')
    def test_fetch_candles_failure(self, mock_get_klines):
